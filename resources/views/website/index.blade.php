                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-7 col-lg-6 d-none d-lg-block">
                            <div class="just-gamers-img">
                                <img src="assets/img/images/just_gamers_img.png" alt="" class="just-gamers-character">
                                <div class="just-gamers-circle-shape">
                                    <img src="assets/img/images/gamers_circle_line.png" alt="">
                                    <img src="assets/img/images/gamers_circle_shape.png" alt="" class="rotateme">
                                </div>
                                <img src="assets/img/images/just_gamers_chart.png" alt="" class="gamers-chart-shape">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 order-0 order-lg-2">
                                <div class="about-img">
                                    ...
                                    <a href="https://www.youtube.com/watch?v=_LTiEXMc5J0" class="popup-video"><img src="assets/img/icon/play_btn.png"  alt=""></a>
                                </div>
                            </div>
                            <div class="col-lg-6">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-xl-6 col-lg-8">
                            <div class="testimonial-area position-relative mb-120">
                                ...
                                <div class="testi-quote"><img src="assets/img/icon/testi_quote.png" alt=""></div>
                            </div>
                        </div>
                    </div>
                </div>
